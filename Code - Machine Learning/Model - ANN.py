...
#   'Director_Avg_Movie_Revenue', 'Studios_Avg_Movie_Revenue', 'Keywords_Avg_Revenue', 'Lead_Actor_Avg_Movie_Revenue', 'Lead_Actor_Movie_Count',
useful = ['Director_Ratio', 'Keywords_Ratio', 'Studios_Ratio', 'Lead_Actor_Ratio', 'Budget']
